...
void loop() {
  ...
  if (valorSW == 1) {
    ...
    //Tras una serie de pruebas, se determinó que, para evitar movimientos indeseados cuando el Joystick no está en movimiento, se debe dejar un rango de datos entre 85 y 95 (no solo en 90).
    if (X >= 85 and X <= 95) {
      //    ALTO
